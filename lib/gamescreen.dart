...
class _GameScreenState extends State<GameScreen> {
  ...
  void dice() {
    if (playerturn == true) {
      ...
      if(bottotalstep==1 || bottotalstep==3 || bottotalstep==6|| bottotalstep==8){
      ...
      }else if(bottotalstep==5||bottotalstep==11 || bottotalstep==13||bottotalstep==14||bottotalstep==16 || bottotalstep==18||bottotalstep==19||bottotalstep==20||totalstep==21||bottotalstep==22||bottotalstep==24||bottotalstep==26||bottotalstep==27 || bottotalstep==29){
        technologyquestion(bottotalstep,whoturn);
      }else if(bottotalstep==7 || bottotalstep==17 || bottotalstep==28){
          ...
          actions: [
            TextButton(
              ...
              onPressed: () {
                ...
                _irAnswer(_iranswer.text.toString(), image, updatemoney, ir,whoturn);
              },
            ),
            TextButton(
                child: Text("Cancel"),
  ...
  void _irAnswer(String answer, int image, int updatemoney, double ir,bool whoturn) {
    ...
    if (ir == 1.0) {
      if (image == 1 || image ==2 || image ==3 || image ==4 || image ==5) {
        if (answer.contains("transition in the manufacturing processes") ||answer.contains("transition in manufacturing processes")||answer.contains("transition in the manufacturing processes from manual to machine production") || answer.contains("manufacturing processes from manual to machine production")) {
          _irmessage("Congratulation. Your answer is correct", trueanswer,updatemoney,whoturn,ir);
        } else {
          _irmessage("Sorry. You are wrong. The correct answer is IR 1.0 is the transition in the manufacturing processes from manual to machine production",
              falseanswer, updatemoney,whoturn, ir);
        }
  ...
  void _irmessage(String ans, bool noanswer, int updatemoney,bool whoturn,double ir) {
    print("until here");
    String title;
    if( noanswer==true){
    ...
    if(whoturn==true){ //player turn
      if (noanswer == true) { //true answer
        _updatescore();
        _updatemoney(updatemoney);
        _updatetechnology(whoturn,ir.toString());
      }else{ //false answer
        _updatemoney(-100);
      } 
    }else{ //bot turn
          ...
          actions: [
            TextButton(
              ...
              onPressed: () {
                print(_iranswer.text);
                Navigator.of(context).pop();
                _technologyAnswer(_iranswer.text.toString(), image, updatemoney, technology,whoturn);
              },
            ),
            TextButton(
                child: Text("Cancel"),
    ...
    if(technology =="Smart Wearable" || technology =="IoT in Health Care"){
      if(image==1 || image ==2 || image ==3|| image ==4 || image ==5){
        if (answer.contains("an electronic device connected to other devices")|| answer.contains("an electronic device generally connected to other devices via wireless protocols")|| answer.contains("an electronic device connected to other devices by using wireless protocols")){
          _technologymessage("Congratulation. Your answer is correct", trueanswer,updatemoney,technology,whoturn);
        } else {
          _technologymessage("Sorry. You are wrong. The correct answer is "+technology+" is an electronic device generally connected to other devices via wireless protocols",
              falseanswer, updatemoney,technology,whoturn);
        }
      ...
      if(image==1 || image ==2 || image ==3|| image ==4 || image ==5){
        if (answer.contains("protection of computer systems and networks against security threats")|| answer.contains("protection of computer system against security threats")){
          _technologymessage("Congratulation. Your answer is correct", trueanswer,updatemoney,technology,whoturn);
        } else {
          _technologymessage("Sorry. You are wrong. The correct answer is "+technology+" is the protection of computer systems and netwoks against security threats",
              falseanswer, updatemoney,technology,whoturn);
        }
      }else if(image==6 || image ==7){
        if (answer.contains("encryption")|| answer.contains("authentication")|| answer.contains("authorisation")){
          _technologymessage("Congratulation. Your answer is correct", trueanswer,updatemoney,technology,whoturn);
        } else {
          _technologymessage("Sorry. You are wrong. The correct answer are encryption, authentication and authorisation",
              falseanswer, updatemoney,technology,whoturn);
        }
      }else if(image==8 || image ==9 || image ==10|| image ==11){
        if (answer.contains("protects the system from unwanted threats in the digital environment")|| answer.contains("protects the system from unwanted attacks in the digital environment")|| answer.contains("protects the system from unwanted threats and attacks in the digital environment")){
          _technologymessage("Congratulation. Your answer is correct", trueanswer,updatemoney,technology,whoturn);
        } else {
          _technologymessage("Sorry. You are wrong. The correct answer is it protects the system from unwanted threats and attacks in the digital environment",
              falseanswer, updatemoney,technology,whoturn);
        }
      }else if(image==12 || image ==13||image==14 ||image ==15){
        if (answer.contains("cost")|| answer.contains("setup and configuration")|| answer.contains("require frequent updates")){
          _technologymessage("Congratulation. Your answer is correct", trueanswer,updatemoney,technology,whoturn);
        } else {
          _technologymessage("Sorry. You are wrong. The correct answer are the cost, setup and configuration and require frequent updates",
              falseanswer, updatemoney,technology,whoturn);
        }
      }else if(image==16){
        _technologymessage("Your opinion is correct",
      ...
      if(image==1 || image ==2 || image ==3|| image ==4 || image ==5){
        if (answer.contains("the rendering of virtual objects to the real-world environment")|| answer.contains("rendering of virtual objects to the real-world environment")){
          _technologymessage("Congratulation. Your answer is correct", trueanswer,updatemoney,technology,whoturn);
        } else {
          _technologymessage("Sorry. You are wrong. The correct answer is "+technology+" is the rendering of virtual objects to the real-world environment",
              falseanswer, updatemoney,technology,whoturn);
        }
      }else if(image==6 || image ==7){
        if (answer.contains("Nintendo's Pokemon Go")){
          ...
          _technologymessage("Sorry. You are wrong. The correct answer is Nintendo's Pokemon Go",
              falseanswer, updatemoney,technology,whoturn);
        }
      }else if(image==8 || image ==9 || image ==10|| image ==11){
        if (answer.contains("creates unique digital experience that blend the diigital and physical worlds")){
          ...
          _technologymessage("Sorry. You are wrong. The correct answer is it creates creates unique digital experience that blend the diigital and physical worlds",
              falseanswer, updatemoney,technology,whoturn);
        }
      }else if(image==12 || image ==13||image==14 ||image ==15){
        if (answer.contains("cost")|| answer.contains("privacy")|| answer.contains("security")){
          ...
          _technologymessage("Sorry. You are wrong. The correct answer is the challenges are the cost, privacy and security",
              falseanswer, updatemoney,technology,whoturn);
        }
      }else if(image==16){
        _technologymessage("Your opinion is correct",
      ...
      if(image==1 || image ==2 || image ==3|| image ==4 || image ==5){
        if (answer.contains("a collection of a large volume of data")){
          ...
          _technologymessage("Sorry. You are wrong. The correct answer is "+technology+" is a collection of a large volumn of data",
              falseanswer, updatemoney,technology,whoturn);
        }
      }else if(image==6 || image ==7){
        if (answer.contains("google search index")|| answer.contains("facebook user profiles database")|| answer.contains("netflix user data")){
          _technologymessage("Congratulation. Your answer is correct", trueanswer,updatemoney,technology,whoturn);
        } else {
          _technologymessage("Sorry. You are wrong. The correct answer is Google search index, Facebook user profiles database and Netflix user data",
              falseanswer, updatemoney,technology,whoturn);
        }
      }else if(image==8 || image ==9 || image ==10|| image ==11){
        if (answer.contains("collects massive data")|| answer.contains("stores massive data")|| answer.contains("analyses massive data")|| answer.contains("collects, stores and analyses massive data")){
          _technologymessage("Congratulation. Your answer is correct", trueanswer,updatemoney,technology,whoturn);
        } else {
          _technologymessage("Sorry. You are wrong. The correct answer is it collects, stores and analyses massive data",
              falseanswer, updatemoney,technology,whoturn);
        }
      }else if(image==12 || image ==13||image==14 ||image ==15){
        if (answer.contains("cost")|| answer.contains("require data scientists and big data experts")|| answer.contains("data quality issues")|| answer.contains("security")){
          _technologymessage("Congratulation. Your answer is correct", trueanswer,updatemoney,technology,whoturn);
        } else {
          _technologymessage("Sorry. You are wrong. The correct answer are the cost, require data scientists and big data experts, data quality issues and security",
              falseanswer, updatemoney,technology,whoturn);
        }
      }else if(image==16){
        _technologymessage("Your opinion is correct",
      ...
      if(image==1 || image ==2 || image ==3|| image ==4 || image ==5){
        if (answer.contains("the process of linking different systems or components to one large system")|| answer.contains("the process of linking different system to one large system")){
          _technologymessage("Congratulation. Your answer is correct", trueanswer,updatemoney,technology,whoturn);
        } else {
          _technologymessage("Sorry. You are wrong. The correct answer is "+technology+" is the process of linking different systems or components to one large system",
              falseanswer, updatemoney,technology,whoturn);
        }
      }else if(image==6 || image ==7){
        if (answer.contains("connecting administration")|| answer.contains("data collection")|| answer.contains("processing payments into one single system")){
          _technologymessage("Congratulation. Your answer is correct", trueanswer,updatemoney,technology,whoturn);
        } else {
          _technologymessage("Sorry. You are wrong. The correct answer are connecting administration, data collection and processing payments into one single system",
              falseanswer, updatemoney,technology,whoturn);
        }
      }else if(image==8 || image ==9 || image ==10|| image ==11){
        if (answer.contains("creates a coordinated system with joined database and data sources")){
          ...
          _technologymessage("Sorry. You are wrong. The correct answer is it creates a coordinated system with joined database and data sources",
              falseanswer, updatemoney,technology,whoturn);
        }
      }else if(image==12 || image ==13||image==14 ||image ==15){
        if (answer.contains("cost")|| answer.contains("security")|| answer.contains("complex upgrading")){
          _technologymessage("Congratulation. Your answer is correct", trueanswer,updatemoney,technology,whoturn);
        } else {
          _technologymessage("Sorry. You are wrong. The correct answer are the cost, security and complex upgrading",
              falseanswer, updatemoney,technology,whoturn);
        }
      }else if(image==16){
        _technologymessage("Your opinion is correct",
      ...
      if(image==1 || image ==2 || image ==3|| image ==4 || image ==5){
        if (answer.contains("industrial production name for 3D printing")){
          ...
          _technologymessage("Sorry. You are wrong. The correct answer is "+technology+" is the industrial production name for 3D printing",
              falseanswer, updatemoney,technology,whoturn);
        }
      }else if(image==6 || image ==7){
        if (answer.contains("3D printing")){
          ...
          _technologymessage("Sorry. You are wrong. The correct answer is 3D printing",
              falseanswer, updatemoney,technology,whoturn);
        }
      }else if(image==8 || image ==9 || image ==10|| image ==11){
        if (answer.contains("print multiple movable parts as a single piece")|| answer.contains("print multiple movable parts as a single piece to save time and cost")){
          _technologymessage("Congratulation. Your answer is correct", trueanswer,updatemoney,technology,whoturn);
        } else {
          _technologymessage("Sorry. You are wrong. The correct answer is it can print multiple movable parts as a single piece to save time and cost",
              falseanswer, updatemoney,technology,whoturn);
        }
      }else if(image==12 || image ==13||image==14 ||image ==15){
        if (answer.contains("cost")|| answer.contains("slow build rate")|| answer.contains("limited component size and volume")|| answer.contains("requires post-processing")){
          _technologymessage("Congratulation. Your answer is correct", trueanswer,updatemoney,technology,whoturn);
        } else {
          _technologymessage("Sorry. You are wrong. The correct answer are the cost, slow build rates, limited component size and volume, and requires post-processing",
              falseanswer, updatemoney,technology,whoturn);
        }
      }else if(image==16){
        _technologymessage("Your opinion is correct",
